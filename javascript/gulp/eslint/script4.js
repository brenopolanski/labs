...
"<br/><div id='uploadstatus'>"),
  ...
  remove_datasource: function(event) {
    ...
    ds.destroy({wait: true, success: function() {
      that.fetch_datasources();$(that.el).find('.user_info').html('');
    }});
  },
  remove_schema: function(event) {
    ...
    s.destroy({wait: true, success: function() {
      that.fetch_schemas();$(that.el).find('.user_info').html('');
    }});
  },
  download_schema: function(event) {
    ...
    s.fetch({wait: true, success: function() {
      alert('here');
    }});
  ...
  remove_user: function(event) {
    ...
    ds.destroy({wait: true, success: function() {
      this.fetch_users();$(that.el).find('.user_info').html('');
    }});
  },
